            ...
            <div className='deliver__page-text'>
              ...
              <span className='deliver__page-span_second'>
                <svg width="41" height="42" viewBox="0 0 41 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1.5 10.9023H39.332V17.8393H1.5V10.9023Z" stroke="#D1B59A" stroke-width="2"/>
                  <path d="M17 10.9023H23.568V40.1003H17V10.9023Z" stroke="#D1B59A" stroke-width="2"/>
                  <path d="M38.069 17.8594H2.93103V40.1004H38.069V17.8594Z" stroke="#D1B59A" stroke-width="2"/>
                  <path d="M20.679 10.7888C20.679 10.7888 20.142 5.75277 21.451 3.47077C22.76 1.18877 26.268 -0.0542263 27.846 2.16177C29.424 4.37677 28.283 9.37777 21.098 10.8888" stroke="#D1B59A" stroke-width="2"/>
                  <path d="M20.494 10.7888C20.494 10.7888 21.0309 5.75277 19.7219 3.47077C18.4129 1.18877 14.905 -0.0542263 13.327 2.16177C11.749 4.37677 12.89 9.37777 20.075 10.8888" stroke="#D1B59A" stroke-width="2"/>
                </svg>
              </span>
            </div>
          </div>
